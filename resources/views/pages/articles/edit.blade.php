<x-layouts.app>
    ...
    <div class="py-8" x-data="{
        ...
        content: '## 소개\n\nLaravel 12가 출시되었습니다. 이번 버전에서는 많은 새로운 기능들이 추가되었는데요.\n\n## 주요 변경사항\n\n1. PHP 8.4 지원\n2. 새로운 Artisan 명령어\n3. 향상된 성능\n\n자세한 내용은 공식 문서를 참고하세요.',
        category: 'tech',
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" class="btn-outline text-red-600 border-red-200 hover:bg-red-50">삭제</button>
